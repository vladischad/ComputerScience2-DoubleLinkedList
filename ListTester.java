 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, Vlad Maliutin
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		Integer[] LIST_CAB = {ELEMENT_C, ELEMENT_B, ELEMENT_A};
		...
		//2-element to 1-element via remove(A)
		testSingleElementList(BA_removeA_B, "BA_removeA_B", LIST_A, STRING_A);

		//2-element to 3-element via addToFront
		testThreeElementList(BA_addToFrontC_CBA, "BA_addToFrontC_CBA", LIST_CAB, STRING_CAB);

		//2-element to 3-element via addToRear
		testThreeElementList(BA_addToRear_BAC, "BA_addToRear_BAC", LIST_BAC, STRING_BAC);

		//2-element to 3-element via addAfter(C,A)
		testThreeElementList(AB_addAfterCA_ACB, "AB_addAfterCA_ACB", LIST_ACB, STRING_ACB);

		//2-element to 3-element via addAfter(C,B)
		testThreeElementList(AB_addAfterCB_ABC, "AB_addAfterCB_ABC", LIST_ABC, STRING_ABC);

		//2-element to changed 2-element via set()
		testTwoElementList(BA_set1A_BA, "BA_set1A_BA", LIST_BA, STRING_BA);

		//3-element to 2-element via remove(C)
		testTwoElementList(CBA_removeC_BA, "CBA_removeC_BA", LIST_BA, STRING_BA);

		//3-element to changed 3-element via set()
		testThreeElementList(CBA_set2A_CBA, "CBA_set2A_CBA", LIST_CAB, STRING_CAB);
	...
	private Scenario<Integer> BA_removeA_B = () -> AB_removeB_A();
	...
	/** Scenario: [B,A] -> addToRear(C) -> [B,A,C] 
	 * @return [B,A,C] after addToRear(C)
	 */
	private IndexedUnsortedList<Integer> BA_addToRear_BAC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToFront(ELEMENT_B); 
		list.addToRear(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> BA_addToRear_BAC = () -> BA_addToRear_BAC();
	 ...
	 */
	private IndexedUnsortedList<Integer> BA_set1A_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToFront(ELEMENT_B); 
		list.set(1,ELEMENT_A);
		return list;
	}
	private Scenario<Integer> BA_set1A_BA = () -> BA_set1A_BA();
	 ...
	 */
	private IndexedUnsortedList<Integer> CBA_removeC_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToFront(ELEMENT_B);
		list.addToFront(ELEMENT_C); 
	...
	private Scenario<Integer> CBA_removeC_BA = () -> CBA_removeC_BA();


	
	/** Scenario: [A,B,C] -> set(2,C) -> [A,B,C] 
	 * @return [A,B,C] after set(2,C)
	 */
	private IndexedUnsortedList<Integer> CBA_set2A_CBA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToFront(ELEMENT_B);
		list.addToFront(ELEMENT_C); 
		list.set(2,ELEMENT_A);
		return list;
	}
	private Scenario<Integer> CBA_set2A_CBA = () -> CBA_set2A_CBA();
